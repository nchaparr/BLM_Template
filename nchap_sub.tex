...
\begin{minipage}[b]{0.5\linewidth}
        ...
        \subfloat[]{\label{main:a}
                \includegraphics[scale=.31]{rss_fit_high}}\\
        \end{minipage}             
\quad
\begin{minipage}[b]{0.5\linewidth}
        \subfloat[]{\label{main:b}          
          
                \includegraphics[scale=.31]{rss_fit_low}}
...
\begin{figure}[htbp]
    ...
    \includegraphics[scale=.5]{height_defs.pdf}
...
\begin{figure}[htbp]
\centering
 \includegraphics[scale=.5]{marg_dist}                 
...
\begin{figure}[htbp]
\centering
 \includegraphics[scale=.76]{scaled_fluxquadhist1}                 
...
\begin{minipage}[b]{0.5\linewidth}
         \subfloat[]{\label{main:a}
                \includegraphics[scale=.3]{downwarm_theta.pdf}}\\
                     
\end{minipage}             
\quad
\begin{minipage}[b]{0.5\linewidth}
         \subfloat[]{\label{main:b}          
               \includegraphics[scale=.3]{scaled_downwarm_theta1.pdf}}\\      
...
\begin{minipage}[b]{0.5\linewidth}
        ...
        \subfloat[]{\label{main:a}
                \includegraphics[scale=.3]{theta_grad_profs}}\\
        \subfloat[]{\label{main:b}
                \includegraphics[scale=.3]{scaleddeltahinvri}}\\
...
\begin{minipage}[b]{0.5\linewidth}
        \subfloat[]{\label{main:c}          
                ...
                \includegraphics[scale=.3]{scaled_theta_grad_profs}}\\      
        \subfloat[]{\label{main:d}          
          
                \includegraphics[scale=.3]{loglog_scaleddeltahinvri_4}}\\      
...
\begin{minipage}[b]{0.5\linewidth}
        ...
        \subfloat[]{\label{main:a}
                \includegraphics[scale=.3]{scaledweinvri_delta_f_GM.png}}\\
        \subfloat[]{\label{main:b}
                \includegraphics[scale=.3]{scaledweinvri_delta.png}}\\
...
\begin{minipage}[b]{0.5\linewidth}
        \subfloat[]{\label{main:c}          
                ...
                \includegraphics[scale=.3]{scaledweinvri_Delta_f_GM}}\\      
        \subfloat[]{\label{main:d}          
          
                \includegraphics[scale=.3]{scaledweinvri_Delta}}\\      
